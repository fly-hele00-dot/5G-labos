...
| `global.gnb.n3if.ipAddress` | The IP address of the UERANSIM’s N3 interface. | `10.47.60.233` |
...
| `gnb.n2if.ipAddress`| The IP address of gNB’s N2 interface. | `10.47.60.250` |
| `gnb.n3if.ipAddress`| The IP address of gNB’s N3 interface. | `10.47.60.236` |
| `gnb.amf.n2if.ipAddress` | The IP address of the AMF’s N2 interface. | `10.47.60.249` |

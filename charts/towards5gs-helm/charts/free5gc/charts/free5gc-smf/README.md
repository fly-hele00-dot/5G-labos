...
| Parameter | Description | Default value |
| --- | --- | --- |
| `global.smf.n4if.ipAddress` | The IP address of the SMF’s N4 interface. | `10.47.60.244` |
...
| `global.n4network.excludeIP` | An exluded IP address from the subnet range. You can give this address to a MACVLAN interface on the host in order to enable to containers to communicate with their host via the N4 interface (optional). | `10.47.60.246` |

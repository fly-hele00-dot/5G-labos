...
if args.action == 'add':
    subscriber_data = {
        ...
        # Current official UDM/UDR (v4.2.3+) use the 3GPP TS 29.504-shaped
        # Udr_DR_AuthenticationSubscription: flat encPermanentKey/encOpcKey
        # hex strings (used directly, not actually encrypted despite the
        # name) and a structured sequenceNumber -- not the old nested
        # milenage/opc/permanentKey objects or a bare sequenceNumber string.
        'subscriptionData.authenticationData.authenticationSubscription': [{
            ...
            'sequenceNumber': {'sqn': '16f3b3f70fc2',

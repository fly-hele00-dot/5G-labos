...
| `global.n3network.subnetIP` | N3 network subnet IP address. | `10.47.60.232` |
| `global.n3network.cidr` | N3 network cidr. | `29` |
| `global.n3network.gatewayIP` | N3 network gateway IP address. | `10.47.60.238` |
...
| `global.n4network.subnetIP` | N4 network subnet IP address. | `10.47.60.240` |
| `global.n4network.cidr` | N4 network cidr. | `29` |
| `global.n4network.gatewayIP` | N4 network gateway IP address. | `10.47.60.246` |
...
| `global.n6network.subnetIP` | N6 network subnet IP address (The IP address of the Data Network. | `10.47.61.0` |
| `global.n6network.cidr` | N6 network cidr. | `24` |
| `global.n6network.gatewayIP` | N6 network gateway IP address (The IP address to go to the Data Network). | `10.47.61.1` |
...
| `global.n9network.subnetIP` | N9 network subnet IP address (The IP address of the Data Network. | `10.47.60.224` |
| `global.n9network.cidr` | N9 network cidr. | `29` |
| `global.n9network.gatewayIP` | N9 network gateway IP address (The IP address to go to the Data Network). | `10.47.60.230` |
...
| `upf.n3if.ipAddress` | The IP address of the UPF’s N3 interface. | `10.47.60.233` |
| `upf.n4if.ipAddress` | The IP address of the UPF’s N4 interface. | `10.47.60.241` |
| `upf.n6if.ipAddress` | The IP address of the UPF’s N6 interface. | `10.47.61.12` |
...
| `upf1.n4if.ipAddress` | The IP address of the UPF1’s N4 interface. | `10.47.60.242` |
| `upf1.n6if.ipAddress` | The IP address of the UPF1’s N6 interface. | `10.47.61.13` |
| `upf1.n9if.ipAddress` | The IP address of the UPF1’s N9 interface. | `10.47.60.226` |
...
| `upf2.n4if.ipAddress` | The IP address of the UPF2’s N4 interface. | `10.47.60.243` |
| `upf2.n6if.ipAddress` | The IP address of the UPF2’s N6 interface. | `10.47.61.14` |
| `upf2.n9if.ipAddress` | The IP address of the UPF2’s N9 interface. | `10.47.60.227` |
...
| `upfb.n3if.ipAddress` | The IP address of the UPFb’s N3 interface. | `10.47.60.233` |
| `upfb.n4if.ipAddress` | The IP address of the UPFb’s N4 interface. | `10.47.60.241` |
| `upfb.n6if.ipAddress` | The IP address of the UPFb’s N6 interface. | `10.47.61.12` |
| `upfb.n9if.ipAddress` | The IP address of the UPFb’s N9 interface. | `10.47.60.225` |
